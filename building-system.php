...
<main class="kit-home-page">
            ...
            <div class="row align-items-center gx-lg-5 modular-row">
                ...
                <div class="col-lg-5">
                    <div class="modular-content-wrapper" style="position: relative; z-index: 1;">
                        <h3 class="mb-5">A Smarter Way to Build</h3>
    ...
    <section class="kit-homes-intro">
        <div class="container d-flex-center align-items-center section-padding h-100">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <p>Modular Kit Homes</p>
                    <h4>Luxwood Kit Homes are proven to be cost-effective, innovative and environmentally friendly. In fact, the design of the homes are constructed with a focus on safety, stability, durability, fire and earthquake resistance.</h4>
                </div>
            </div>
        </div>
    </section>
                ...
                <nav class="col-lg-3 kit-home-nav" aria-label="Section navigation">
                    <ul class="kit-home-nav-list">
                        <li class="kit-home-nav-item is-active">
                            <a href="#" data-slide="0">
                                <span class="kit-home-nav-label">Coomera</span>
                            </a>
                        </li>
                        <li class="kit-home-nav-item">
                            <a href="#" data-slide="1">
                                <span class="kit-home-nav-label">Drift Home</span>
                            </a>
                        </li>
                        <li class="kit-home-nav-item">
                            <a href="#" data-slide="2">
        ...
        <div class="container d-flex-center align-items-center section-padding h-100">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <h4 class="mb-4">PHE modular buildings are designed for flexibility and deployment in remote or hard-toaccess locations. </h4>
        ...
        <div class="container">
            <div class="modular-applications-wrapper">
                <div class="row gx-3 gx-lg-5">
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-between">
                        ...
                        <a href="#" class="">View Images <i class="fa-solid fa-arrow-right-long" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="modular-applications-wrapper">
                <div class="row gx-3 gx-lg-5">
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-between">
                        <div>
                            <h4>12m x 3m Modular Building</h4>
